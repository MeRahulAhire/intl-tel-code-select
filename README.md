# International-telephone-select-code
> This is an curated list of telephone calling code for all the country/territory thats formated in `<Select/>` tag
...
### All of the above data are pretty acurate

But, if you happen to find any error just hit up an issue and I'll make sure to check and fix it if there's some error in it.
